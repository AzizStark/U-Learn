        ...
        axios.get('/api/enrolledtitles', {
            ...
            .then(res => {
                if (res.data.length !== 0) {
                    this.setState({
                        scontent: this.state.scontent.concat(res.data.courses),
        ...
        return (
            <div className={`columns ${dstyles.dashboard}`} style={{ paddingBottom: 0 }}>
                ...
                <div className="column" >
                    <h2 style={{ fontSize: 40, color: 'white', textAlign: 'center', fontWeight: 700, letterSpacing: '0.05em' }} className="title"> Student's Dashboard </h2>
                    <div style={{ minWidth: '68vw' }}>
                        ...
                        <br />
                        <center><h1 className="title" style={{ color: 'white' }}> Enrolled Courses </h1> </center>
                        <br />
                        {this.state.pivot !== 0 ? (
                                        ...
                                        <nav className="level">
                                            ...
                                            <div className={`level-left ${dstyles.dtitle}`}>
                                                ...
                                                <div style={{ paddingLeft: 15 }}>
                                                    ...
                                                    <p style={{ fontSize: 14, color: '#AAAAAA', textTransform: 'uppercase' }}>{post.author}</p>
                                                </div>
                                            </div>
